...
Одновременно может работать только один update. Если update уже идёт, ручной или автоматический запуск не стартует второй процесс. 1 час используется только для проверки устаревшего lock-файла; живой update может работать дольше.
