...
Одновременно может работать только один update. Ручной запуск доступен через 1 час после предыдущего старта любого update, включая автоматический. Автозапуск по расписанию выполняется всегда, кроме случая, когда update уже идёт. Ограничения на длительность нет; 1 час используется только для проверки устаревшего lock-файла.
